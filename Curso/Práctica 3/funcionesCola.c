...
/*Funciones para crear numero, nodo e inicializar una cola */
...
/*Las colas funcionan solo con la funcion encolar y desencolar, que son lo mismo
que insertar cola y quitar cola */
